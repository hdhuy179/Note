...
// cái subject nào emit trước thì chỉ emit từ cái subject đó
example(of: "Swiftch") {
    let left = PublishSubject<String>()
    let right = PublishSubject<String>()
...
example(of: "switchLatest") {
    // 1
//    let one = BehaviorSubject<String>(value: "")
//    let two = BehaviorSubject<String>(value: "")
//    let three = BehaviorSubject<String>(value: "")
//    let source = BehaviorSubject<Observable<String>>(value: Observable.of(""))
