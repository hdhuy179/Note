...
//        print(sharedConfig.fileURL!)
        print(String(data: "123123123".sha512()!, encoding: .utf8))
        print("123123123".sha512()!.base64EncodedString())
        print("123123124".sha512()!.base64EncodedString())
        print("123123123".md5()!.base64EncodedString())
        print("123123124".md5()!.base64EncodedString())
    ...
    func md5() -> Data? {
        ...
        _ = result.withUnsafeMutableBytes { resultBytes in
            stringData.withUnsafeBytes { stringBytes in
                CC_MD5(stringBytes, CC_LONG(stringData.count), resultBytes)
            }
        }
        return result
    }
